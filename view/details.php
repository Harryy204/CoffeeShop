...
<body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                if (mysqli_query($con, $insertQuery)) {
                    header("Location: index.php?act=details&id=$id");
                    exit();
                } else {
    ...
    if (isset($_GET['id'])) {
        ...
        $result = mysqli_query($con, "SELECT * FROM sanpham WHERE id = '$id'");
    ...
    ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="./uploadimage/<?php echo $product['img']; ?>" alt="Product Image" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12 text-left">
                        <a href="<?php echo $product['img']; ?>" target="_blank">
                            <img src="./uploadimage/<?php echo $product['img']; ?>" alt="Thumbnail Image" class="img-thumbnail mt-2" width="70px">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container mt-5">
                ...
                <?php
                    ...
                    echo "<p>Vui lòng <a href='index.php?act=login'>đăng nhập</a> để thêm bình luận</p>";
                }
                ?>
            </div>
            ...
            <div class="container mt-5">
                ...
                <div class="row">
                    ...
                    ?>
                            <div class="col-md-3">
                                <a href="index.php?act=details&id=<?php echo $relatedProduct['id']; ?>" class="text-decoration-none">
                                    <div class="card">
                                        <img src="./uploadimage/<?php echo $relatedProduct['img']; ?>" class="card-img-top" alt="Product Image">
                                        <div class="card-body">

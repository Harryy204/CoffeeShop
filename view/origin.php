...
<body>
    <img src="./images/origin.jpg" alt="Lịch sử" style="width:100%">
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title">NGUỒN NGUYÊN LIỆU</h1>
                        <p class="card-text">
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src="./images/origin.jpg" class="card-img-top" style="height: 500px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid bg-3 text-center mt-4 mb-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                <a href="index.php?act=history" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                    <div class="card">
            ...
            <div class="col-sm-4">
                <a href="index.php?act=origin" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                    <div class="card">
            ...
            <div class="col-sm-4">
                <a href="index.php?act=mission" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                    <div class="card">
